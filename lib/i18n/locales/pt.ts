export const pt = {
    ...
    features: {
        header: {
            main: "Tecnología IA + Estrategistas de Marketing =",
        ...
        list: [
            ...
            {
                title: "Modelos de Crecimiento IA",
    ...
    footer: {
        ...
        contact: "Contacto",
        login: "Entrar",
        copyright: "Todos os derechos reservados.",
        professional: {
    ...
    pricing: {
        ...
        premium: {
            ...
            desc: "Máxima velocidade e qualidade com Inteligencia Artificial.",
    ...
    plan: {
        ...
        normal: {
            title: "Plano Normal",
            subtitle: "Crecimiento constante e seguro",
            cta: "Selecionar Normal",
        },
        premium: {
            title: "Plano Premium",
            subtitle: "Crecimiento acelerado com IA",
