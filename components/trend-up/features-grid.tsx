                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                    <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-slate-600">
                            Crowd Ignite nunca le pide la contraseña de su cuenta como otras empresas, evitando cualquier riesgo de ser suspendido. Cumplimos todas las directrices de IG.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-slate-600">
                            Crowd Ignite se asegura de que tus nuevos fans no sólo te sigan, sino que disfruten de lo que compartes y quieran ver más.
                        </p>
                    </div>
                    ...
                    <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-slate-600">
                            Solo crecimiento inteligente en redes sociales. Verás un crecimiento inmediato gracias a la tecnología GPT4 de Crowd Ignite.
                        </p>
                    </div>
                </div>
