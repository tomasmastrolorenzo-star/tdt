            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-slate-600 max-w-2xl mx-auto">
                        Descubre por qué los influencers y las marcas confían en TDT con su crecimiento y éxito en las redes sociales
                    </p>
                </div>
                ...
                <div className="max-w-md mx-auto bg-white rounded-3xl p-8 shadow-xl border border-slate-100">
                    ...
                    <p className="text-slate-600 leading-relaxed">
                        TDT es imprescindible si te gusta la gastronomía y quieres ampliar tu alcance en Instagram. He probado varias plataformas, pero TDT's La innovadora tecnología me ha ayudado a duplicar mi número de seguidores en semanas. Ha sido una forma estupenda...
                    </p>
                </div>
            </div>
        </section>
