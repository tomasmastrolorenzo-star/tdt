...
function ServiciosContent() {
  ...
  const tiers = [
    ...
    },
    {
      ...
      name: "VIRAL MOMENTUM",
      price: 99,
      // Updated copy: Viral Velocity + Dynamic Features
      features: ["Accelerated Growth Engine", "AI Viral Strategy", `Smart ${nicheName} Hashtags`, `${locationName} Targeted Audience`, "Priority Optimization"],
    ...
    },
    {
      ...
      name: "BRAND PARTNER",
      price: 249,
      // Updated copy: Brand Dominance
      features: ["Maximum Velocity", "Dedicated Account Manager", "Full-Scale Reputation Mgmt", "Authority Building"],
